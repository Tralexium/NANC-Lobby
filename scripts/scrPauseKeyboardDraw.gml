...
if(pause_options_keyboard_alpha > 0) {
    draw_set_font(fMenuLobby12)
    var _option_y;
    var _upper_threshold_alpha;
    var _bottom_threshold_alpha;
    var _option_alpha;
    for(var i=0; i<pause_options_keyboard_max_index; i++) {
        // Draw the left side
        _option_y = pause_options_keyboard_target_y + (i * pause_options_seperation);
        ...
        draw_set_alpha(_option_alpha * pause_options_keyboard_alpha);
        if(i == pause_options_keyboard_max_index - 1)
        ...
        // Draw the right side
        if(pause_setting_key && i == pause_options_keyboard_index)
