/// scrFBPFadeOrb(x, y, size[optional], dir[optional], dir_incr[optional], speed[optional], spd_incr[optional], size_incr[optional], fade_spd[optional])
...
var _obj = instance_create(_x, _y, objAlexFBPFadeOrb);
...
if(argument_count > 8) {
    _fade_spd = argument[8];
    _obj.fade_spd = _fade_spd;
}
