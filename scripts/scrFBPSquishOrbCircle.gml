///scrFBPSquishOrbCircle(x, y, circle_angle, amount, size[optional], dir_incr[optional], speed[optional], spd_incr[optional], size_incr[optional])
...
{
    var _obj = instance_create(_x, _y, objAlexFBPSquishOrb);
